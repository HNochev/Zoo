    ...
    public partial class InitialMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    AnimalKind = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    InZooSince = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Count = table.Column<int>(type: "int", nullable: false),
                    Description = table.Column<string>(type: "nvarchar(max)", maxLength: 5000, nullable: true),
                    AnimalConditionId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Animals_AnimalConditions_AnimalConditionId",
                        column: x => x.AnimalConditionId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    UsernameInWebsite = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BuyedTickets", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BuyedTickets_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BuyedTickets_Tickets_TicketId",
                        column: x => x.TicketId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PhotoStatusId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Animals_AnimalConditionId",
                table: "Animals",
                column: "AnimalConditionId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BuyedTickets_TicketId",
                table: "BuyedTickets",
                column: "TicketId");

            migrationBuilder.CreateIndex(
                name: "IX_BuyedTickets_UserId",
                table: "BuyedTickets",
                column: "UserId");
